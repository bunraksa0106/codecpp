...
void sortSample(){
    ...
    for(i=0;i<n;i++){
        for(i=i+1;j<n;j++){
            if(obj[i].getdata3()>obj[j].getdata3())
               temp=obj[i].getdata3()
               obj[i].getdata3()=obj[j].getdata3()
               obj[j].getdata3()=temp;
        }
    }
}
